...
GROUNDTRUTH_MAP = {
    ...
    "LI_EXPULSION_TWO_10FPS": ("Li_Expulsion_2x10.tif", 20000),    
    "LI_EXPULSION_TWO_ORIGINAL": ("Li_Expulsion_2.tif", 20000),
    ...
    #"EDS_AEROSPACE_TWO_downscale":   ("EDS_aerospace_2_halfres.tif", 20000),
    #"TITANIUM_STRAIN_ONE_downscale": ("Titanium_strain_halfres.tif", 20000)
}
